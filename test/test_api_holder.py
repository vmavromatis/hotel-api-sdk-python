...
from bookingapi.models.api_holder import ApiHolder


class TestApiHolder(unittest.TestCase):
    """ ApiHolder unit test stubs """
    ...
    def testApiHolder(self):
        """
        Test ApiHolder
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = bookingapi.models.api_holder.ApiHolder()
        pass
