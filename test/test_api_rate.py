...
from bookingapi.models.api_rate import ApiRate


class TestApiRate(unittest.TestCase):
    """ ApiRate unit test stubs """
    ...
    def testApiRate(self):
        """
        Test ApiRate
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = bookingapi.models.api_rate.ApiRate()
        pass
