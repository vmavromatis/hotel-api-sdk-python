...
from bookingapi.apis.checkrates_api import CheckratesApi


class TestCheckratesApi(unittest.TestCase):
    """ CheckratesApi unit test stubs """

    def setUp(self):
        self.api = bookingapi.apis.checkrates_api.CheckratesApi()
