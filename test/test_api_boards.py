...
from bookingapi.models.api_boards import ApiBoards


class TestApiBoards(unittest.TestCase):
    """ ApiBoards unit test stubs """
    ...
    def testApiBoards(self):
        """
        Test ApiBoards
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = bookingapi.models.api_boards.ApiBoards()
        pass
