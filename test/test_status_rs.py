...
from bookingapi.models.status_rs import StatusRS


class TestStatusRS(unittest.TestCase):
    """ StatusRS unit test stubs """
    ...
    def testStatusRS(self):
        """
        Test StatusRS
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = bookingapi.models.status_rs.StatusRS()
        pass
