...
from bookingapi.models.api_cost import ApiCost


class TestApiCost(unittest.TestCase):
    """ ApiCost unit test stubs """
    ...
    def testApiCost(self):
        """
        Test ApiCost
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = bookingapi.models.api_cost.ApiCost()
        pass
