...
from bookingapi.models.api_rooms import ApiRooms


class TestApiRooms(unittest.TestCase):
    """ ApiRooms unit test stubs """
    ...
    def testApiRooms(self):
        """
        Test ApiRooms
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = bookingapi.models.api_rooms.ApiRooms()
        pass
