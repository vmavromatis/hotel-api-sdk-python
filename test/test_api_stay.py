...
from bookingapi.models.api_stay import ApiStay


class TestApiStay(unittest.TestCase):
    """ ApiStay unit test stubs """
    ...
    def testApiStay(self):
        """
        Test ApiStay
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = bookingapi.models.api_stay.ApiStay()
        pass
