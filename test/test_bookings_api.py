...
from bookingapi.apis.bookings_api import BookingsApi
...
class TestBookingsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = bookingapi.apis.bookings_api.BookingsApi()
    ...
    def test_booking_cancellation(self):
        """
        Test case for booking_cancellation
