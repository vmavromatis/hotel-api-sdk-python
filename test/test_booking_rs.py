...
from bookingapi.models.booking_rs import BookingRS


class TestBookingRS(unittest.TestCase):
    """ BookingRS unit test stubs """
    ...
    def testBookingRS(self):
        """
        Test BookingRS
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = bookingapi.models.booking_rs.BookingRS()
        pass
