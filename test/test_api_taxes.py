...
from bookingapi.models.api_taxes import ApiTaxes


class TestApiTaxes(unittest.TestCase):
    """ ApiTaxes unit test stubs """
    ...
    def testApiTaxes(self):
        """
        Test ApiTaxes
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = bookingapi.models.api_taxes.ApiTaxes()
        pass
