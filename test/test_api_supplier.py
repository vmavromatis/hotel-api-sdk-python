...
from bookingapi.models.api_supplier import ApiSupplier


class TestApiSupplier(unittest.TestCase):
    ...
    def testApiSupplier(self):
        """
        Test ApiSupplier
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = bookingapi.models.api_supplier.ApiSupplier()
        pass
