...
from bookingapi.models.api_voucher import ApiVoucher


class TestApiVoucher(unittest.TestCase):
    """ ApiVoucher unit test stubs """
    ...
    def testApiVoucher(self):
        """
        Test ApiVoucher
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = bookingapi.models.api_voucher.ApiVoucher()
        pass
