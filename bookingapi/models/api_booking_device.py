...
class ApiBookingDevice(object):
    ...
    def __init__(self, id=None, ip=None):
        """
        ApiBookingDevice - a model defined in Swagger
        """
    ...
    def id(self):
        """
        Gets the id of this ApiBookingDevice.

        :return: The id of this ApiBookingDevice.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this ApiBookingDevice.

        :param id: The id of this ApiBookingDevice.
        :type: str
        """
    ...
    def ip(self):
        """
        Gets the ip of this ApiBookingDevice.

        :return: The ip of this ApiBookingDevice.
        :rtype: str
        """
        return self._ip
    ...
    def ip(self, ip):
        """
        Sets the ip of this ApiBookingDevice.

        :param ip: The ip of this ApiBookingDevice.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ApiBookingDevice):
            return False
