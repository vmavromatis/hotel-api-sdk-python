...
class ApiPromotion(object):
    ...
    def __init__(self, code=None, name=None, remark=None):
        """
        ApiPromotion - a model defined in Swagger
        """
    ...
    def code(self):
        """
        Gets the code of this ApiPromotion.

        :return: The code of this ApiPromotion.
        :rtype: str
        """
        return self._code
    ...
    def code(self, code):
        """
        Sets the code of this ApiPromotion.

        :param code: The code of this ApiPromotion.
        :type: str
        """
    ...
    def name(self):
        """
        Gets the name of this ApiPromotion.

        :return: The name of this ApiPromotion.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this ApiPromotion.

        :param name: The name of this ApiPromotion.
        :type: str
        """
    ...
    def remark(self):
        """
        Gets the remark of this ApiPromotion.

        :return: The remark of this ApiPromotion.
        :rtype: str
        """
        return self._remark
    ...
    def remark(self, remark):
        """
        Sets the remark of this ApiPromotion.

        :param remark: The remark of this ApiPromotion.
        :type: str
        """
