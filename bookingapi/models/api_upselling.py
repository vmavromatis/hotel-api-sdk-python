...
class ApiUpselling(object):
    ...
    def __init__(self, room=None):
        """
        ApiUpselling - a model defined in Swagger
        """
    ...
    def room(self):
        """
        Gets the room of this ApiUpselling.

        :return: The room of this ApiUpselling.
        :rtype: list[Room]
        """
        return self._room
    ...
    def room(self, room):
        """
        Sets the room of this ApiUpselling.

        :param room: The room of this ApiUpselling.
        :type: list[Room]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ApiUpselling):
            return False
