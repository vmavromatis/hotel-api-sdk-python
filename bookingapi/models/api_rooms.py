...
class ApiRooms(object):
    ...
    def __init__(self, room=None, included=False):
        """
        ApiRooms - a model defined in Swagger
        """
    ...
    def room(self):
        """
        Gets the room of this ApiRooms.

        :return: The room of this ApiRooms.
        :rtype: list[str]
        """
        return self._room
    ...
    def room(self, room):
        """
        Sets the room of this ApiRooms.

        :param room: The room of this ApiRooms.
        :type: list[str]
        """
        if room is None:
    ...
    def included(self):
        """
        Gets the included of this ApiRooms.

        :return: The included of this ApiRooms.
        :rtype: bool
        """
    ...
    def included(self, included):
        """
        Sets the included of this ApiRooms.

        :param included: The included of this ApiRooms.
        :type: bool
        """
        if included is None:
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ApiRooms):
            return False
