...
class ApiVoucher(object):
    ...
    def __init__(self, language=None, email=None):
        """
        ApiVoucher - a model defined in Swagger
        """
    ...
    def language(self):
        """
        Gets the language of this ApiVoucher.

        :return: The language of this ApiVoucher.
        :rtype: str
        """
    ...
    def language(self, language):
        """
        Sets the language of this ApiVoucher.

        :param language: The language of this ApiVoucher.
        :type: str
        """
    ...
    def email(self):
        """
        Gets the email of this ApiVoucher.

        :return: The email of this ApiVoucher.
        :rtype: ApiVoucherEmail
        """
        return self._email
    ...
    def email(self, email):
        """
        Sets the email of this ApiVoucher.

        :param email: The email of this ApiVoucher.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ApiVoucher):
            return False
