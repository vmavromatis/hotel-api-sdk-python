...
class BookingDetailRS(object):
    ...
    def __init__(self, echo_token=None, audit_data=None, error=None, booking=None):
        """
        BookingDetailRS - a model defined in Swagger
        """
    ...
    def echo_token(self):
        """
        Gets the echo_token of this BookingDetailRS.

        :return: The echo_token of this BookingDetailRS.
        :rtype: str
        """
    ...
    def echo_token(self, echo_token):
        """
        Sets the echo_token of this BookingDetailRS.

        :param echo_token: The echo_token of this BookingDetailRS.
        :type: str
        """
    ...
    def audit_data(self):
        """
        Gets the audit_data of this BookingDetailRS.

        :return: The audit_data of this BookingDetailRS.
        :rtype: ApiAuditData
        """
    ...
    def audit_data(self, audit_data):
        """
        Sets the audit_data of this BookingDetailRS.

        :param audit_data: The audit_data of this BookingDetailRS.
        :type: ApiAuditData
        """
    ...
    def error(self):
        """
        Gets the error of this BookingDetailRS.

        :return: The error of this BookingDetailRS.
        :rtype: ApiError
        """
        return self._error
    ...
    def error(self, error):
        """
        Sets the error of this BookingDetailRS.

        :param error: The error of this BookingDetailRS.
        :type: ApiError
        """
    ...
    def booking(self):
        """
        Gets the booking of this BookingDetailRS.

        :return: The booking of this BookingDetailRS.
        :rtype: ApiBooking
        """
    ...
    def booking(self, booking):
        """
        Sets the booking of this BookingDetailRS.

        :param booking: The booking of this BookingDetailRS.
        :type: ApiBooking
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, BookingDetailRS):
            return False
